  ...
  return (
    <SiteShell>
      ...
      <section className="sec2"><div className="wrap2">
        <div className="eyebrow2">The framework</div>
        <h2 className="h2-2">The TPO Method, in three moves.</h2>
        <p className="sub" style={{ maxWidth: 640 }}>Every piece of content earns its keep by doing one of three jobs. Run them in rhythm and a quiet account becomes a booking machine.</p>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(220px,1fr))', gap: 16, marginTop: 24 }}>
          <div className="qbox">
            <div className="eyebrow2">Teach</div>
            <div className="big" style={{ marginTop: 6 }}>Earn trust</div>
            <p>Give away what you know. Useful, specific, repeatable. Your audience learns something today and sees you as the guide who can fix the rest.</p>
          </div>
          <div className="qbox">
            <div className="eyebrow2">Prove</div>
            <div className="big" style={{ marginTop: 6 }}>Earn belief</div>
            <p>Show the receipts. Client wins, before and afters, real numbers. Proof turns a claim into a reason to believe you.</p>
          </div>
          <div className="qbox">
            <div className="eyebrow2">Offer</div>
            <div className="big" style={{ marginTop: 6 }}>Earn the booking</div>
            <p>Make the ask clear and easy. One next step, zero friction. Attention becomes a booked call.</p>
          </div>
        </div>
        <p className="sub" style={{ maxWidth: 640, marginTop: 24 }}>Underneath it all run the 3Cs (Clarity, Consistency, Credibility) and the Clarity Mirror Method, the tools that keep your voice sharp and your message landing. The course installs the whole system with you, step by step.</p>
      </div></section>
