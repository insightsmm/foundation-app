...
type Area = 'brandos' | 'engine' | 'proof' | 'analyzer';
  ...
  return (
    <div className="shell">
      <aside className="rail">
        ...
        <Link className="navitem" href="/">← Back to homepage</Link>
      ...
      <main className="main">
        {!active ? (
          ...
          <Analyzer key={active.id} brand={active} userId={userId} brandId={active.id} />
        )}
      </main>
    </div>
  );
